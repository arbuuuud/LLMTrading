...
class TestLiveBridge(unittest.TestCase):
    ...
    def test_multi_timeframe_bar_aggregator(self):
        ...
        m1, m2, m3, m15 = aggregator.process_tick("XAUUSD", bid=3300.0, ask=3300.20, spread=0.20, timestamp_ms=t0)
        ...
        completed_m1, completed_m2, completed_m3, completed_m15 = aggregator.process_tick("XAUUSD", bid=3301.0, ask=3301.20, spread=0.20, timestamp_ms=t0 + 65000)
        ...
        t30 = t0 + (16 * 60 * 1000)
        m1_next, m2_next, m3_next, m15_final = aggregator.process_tick("XAUUSD", bid=3305.0, ask=3305.20, spread=0.20, timestamp_ms=t30)
